...
description: "如何才能提高写作效率？使用Markdown 快速画流程图、时序图、甘特图，生成对应的思维导图。"
tags: ["Typora"]
categories: ["工具"]
...
工作、生活中有很多写文档的需求，如何才能提高写作效率？选择**合适的工具**加**恰当的方法**。下面分享一些工具和方法，为你的写作效率助力。
...
其它更多的图表也可以使用[图说](https://tushuo.baidu.com/)在线画，然后导出图片。
