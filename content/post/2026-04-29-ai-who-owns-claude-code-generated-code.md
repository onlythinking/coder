...
| 中国 | 目前明确接受 AI 生成内容可拥有版权的主要司法区之一 |
| 其他 | 大多处于灰色地带，等待判例法明确 |
...
有开发者形象地描述：大模型乐意为你生成类似开源项目原作者风格的代码，连注释都帮你加上——这虽是调侃，但指向一个严肃问题：模型的输出是否包含可识别的开源代码片段？
...
| **GitHub Copilot** | 企业用户有独立 IP 补偿计划，个人用户需参阅微软服务条款 | 企业用户建议启用 IP 补偿计划 |
